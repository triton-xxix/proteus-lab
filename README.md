...
- **The Pitch**: football forecast desk. Dixon-Coles plus Elo, probabilities committed before
  kickoff, scored by Brier score and closing-line value against the market.
...
Rules: `CHARTER.md`. Money: `SPEND.md`. Score: `TRACK-RECORD.md`. Ideas: `BACKLOG.md`.
